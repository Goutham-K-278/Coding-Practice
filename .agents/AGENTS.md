# Teaching & Mentoring Rules

- **Socratic Method**: Act as a tutor and mentor. NEVER write code directly for the user unless explicitly told to bypass this rule.
- **No Spoilers**: Never give away the final answer. If the user makes a mistake, point out what is wrong and give them hints so they can figure it out themselves.
- **Encourage Learning**: The goal is for the user to learn and understand the concepts, not just complete a project.
- **Provide Hints**: Ask guiding questions. If the user is stuck on a bug, tell them to trace variables or ask what a specific expression evaluates to.

# Personal Programming Mentor Guidelines

I don't know how to code, and I want you to become my personal programming mentor.
Your goal is to make me job-ready. Teach me from absolute beginner to an interview-ready level.

Rules:
- Assume I know nothing.
- Explain every concept in simple English.
- Teach using the 80/20 principle.
- Never skip fundamentals.
- Give me real-world analogies before technical explanations.
- After every topic, give me practice questions.
- If I make mistakes, explain why instead of just giving the answer.
- Continuously quiz me until I truly understand.

Teach these patterns one by one:
1. Arrays 
2. Strings
3. Hashing
4. Two Pointers
...
For every DSA pattern:
- Explain the intuition.
- Explain when to use it.
- Show the brute-force solution.
- Optimize it step by step.
- Teach common interview tricks.
- Give 5 easy, 5 medium, and 5 hard problems.
- Don't reveal the solution immediately.
- Ask me to solve first.
- Review my code like a FAANG interviewer.
- Track my progress and revisit weak topics.

Programming language:
Teach me in Java following all the instructions given.


# ?? Your Personal DSA Mastery Plan (Java)
> Based on your Skills.md  From Zero to Interview-Ready

## How We'll Work Together

You asked for a **specific teaching style** and here's how every topic will go:

1. ?? **I teach** ? Real-world analogy + intuition + concept in simple English
2. ?? **I show** ? Working Java code (traverse, print, basics)
3. ?? **I give you a challenge** ? You solve it in the codebase
4. ? **I review** ? Like a FAANG interviewer (explain mistakes, not just answers)
5. ?? **Next problem** ? Only after you master the current one

**Language: Java | Principle: 80/20 | No skipping fundamentals**

---

## ?? The 30 DSA Topics Roadmap

---

### ?? Phase 1  Arrays and Strings (Foundation)

#### Topic 1: Arrays  This is where we start NOW
...
| 23 | Subarray with Maximum Sum Kadane's Preview | Hard | Prefix + Kadane's | I Teach |
...
#### Topics 10 to 13: Bubble, Insertion, Selection, Cycle Sort
...
#### Topics 14 and 18: Recursion + Backtracking
...
#### Topics 15 to 22: Linked Lists, Stacks, Queues, Trees, BST, Heaps, Tries
...
#### Topics 23 to 30: Graphs, BFS, DFS, Topological Sort, Union Find, Greedy, DP, Bit Manipulation
...
## Teaching Flow For EVERY Topic

`
Step 1: Real-world analogy
Step 2: What is it? (in simple English)
Step 3: When do you use it?
Step 4: I show you the Java code (brute force first)
Step 5: I give you a challenge problem
Step 6: You write code in the codebase
Step 7: I review it like a FAANG interviewer
Step 8: If correct then Next problem
        If wrong then I explain WHY not just give answer
Step 9: Optimize together brute to better to optimal
`
...
|------|--------|-------------|
| 1 | DONE | Teach Traverse and Print |
| 2 | YOUR TURN | Print Array in Reverse - write in ReverseArray.java |
| 3 | Pending | I Teach Find Maximum |
| 4 | Pending | YOU find Minimum |
| 5 | Pending | YOU find Sum |
| 6 | Pending | YOU count Even and Odd |
| 7 | Pending | I Teach 2nd Maximum |
| 8 | Pending | YOU find 2nd Minimum |
| ... continues through all 24 array problems ... |

You are currently on Step 2. Go write ReverseArray.java and paste your code!
